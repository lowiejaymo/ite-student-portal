<!-- officer-event-edit.php and to edit event in officer form.
Authors:
...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer') { // Check if the role is set and it's 'Officer'
    ...
    <head>
        ...
        <title>Officer Edit Event | ITE Student Portal</title>
                            ...
                            <div class="col-md-8">
                                <div class="card card-primary card-outline bg-white" for="new-subject">
                                    <div class="card-header">
                                        ...
                                        <form action="indexes/officer-event-edit-be.php" method="post">
                                            ...
                                            <div class="offset-sm-2 col-sm-10">
                                                ...
                                                <a type="button" name="cancel" class="btn btn-secondary"
                                                    href='officer-event-view.php?event_id=<?php echo $_GET['event_id']; ?>'>Cancel</a>
                                            </div>
