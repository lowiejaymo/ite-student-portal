<!-- admin-event-present-student-bulk.php and to present a student in that event by importing excel in admin form.
Authors:
...
<head>
  ...
  <title>Admin Event Bulk Marking | ITE Student Portal </title>
                  ...
                  <div class="col-md-8">
                    <div class="card card-primary card-outline bg-white" for="new-subject">
                      <div class="card-header">
                        ...
                        <form action="indexes/admin-event-present-student-bulk-be.php" method="post"
