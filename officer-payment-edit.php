<!-- officer-payment-edit.php and to edit payments in officer form.
Authors:
...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer') { // Check if the role is set and it's 'Officer'
    ...
    <head>
        ...
        <title>Officer Payment Edit Information | ITE Student Portal</title>
                                    ...
                                    <div class="card-header">
                                        ...
                                        <form action="indexes/officer-payment-edit-be.php" method="post">
                                            ...
                                            <input type="hidden" name="payment_for_id"
                                                value="<?php echo $paymentfor['payment_for_id']; ?>">

                                            <div class="form-group">
                                                <label for="paymentforname">Payment Description</label>
                                                <input type="text" class="form-control" id="paymentfor_name"
