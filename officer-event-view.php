                            ...
                            <div class="col-md">
                                <div class="table-responsive">
                                    ...
                                    <div class="col-md-auto ml-auto">
                                        <a href="officer-event-add-student.php?event_id=<?php echo $row['event_id']; ?>" class="btn btn-success btn-sm d-block mb-2"><i class="nav-icon fas fa-solid fa-plus"></i> Add Student</a>
                                        <a href="officer-event-edit.php?event_id=<?php echo $row['event_id']; ?>" class="btn btn-secondary btn-sm d-block mb-2"><i class="nav-icon fas fa-regular fa-pen-to-square"></i> Edit event</a>
                                        <a href="officer-event-delete-student.php?event_id=<?php echo $row['event_id']; ?>" class="btn btn-danger btn-sm d-block mb-2"><i class="nav-icon fas fa-solid fa-minus"></i> Delete Student</a>
                                    </div>
                                    <?php
                                            } else {
